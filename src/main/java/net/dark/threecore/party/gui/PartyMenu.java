...
public final class PartyMenu {
    ...
    public Inventory build(Player player) {
        ...
        if (service.isInParty(player.getUniqueId()) && !service.isLeader(player.getUniqueId())) return inv;
    ...
    public Inventory buildSummary(Player player) {
        ...
        inv.setItem(13, button(Material.ENDER_PEARL, "<gradient:#f4cd2a:#eda323:#d28d0d>Queue Ready</gradient>", List.of(
