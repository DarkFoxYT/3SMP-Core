...
public final class PartyMenu {
    ...
    public Inventory build(Player player) {
        ...
        inv.setItem(10, button(Material.GOAT_HORN, "<gradient:#34d399:#22c55e>Create Party</gradient>", List.of("<gray>Create a party if you are solo.</gray>", "<gray>Once created, your hotbar manager becomes a lectern.</gray>")));
        inv.setItem(12, button(Material.NAME_TAG, "<gradient:#60a5fa:#c084fc>Invite Player</gradient>", List.of("<gray>Use /party invite <player>.</gray>")));
        inv.setItem(14, button(Material.PLAYER_HEAD, "<gradient:#a78bfa:#f472b6>Members</gradient>", List.of("<gray>Show current party members.</gray>")));
        inv.setItem(16, button(Material.ARROW, "<gradient:#D6E8F7:#FFFFFF>Leave Party</gradient>", List.of("<gray>Leave your current party.</gray>", "<gray>Leaders should use the hotbar disband button.</gray>")));
