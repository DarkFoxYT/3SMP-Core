    ...
    public void init() {
        try {
            ...
            try (Statement st = connection.createStatement()) {
                ...
                st.executeUpdate("CREATE TABLE IF NOT EXISTS player_homes (uuid TEXT NOT NULL, name TEXT NOT NULL, world TEXT NOT NULL, x REAL NOT NULL, y REAL NOT NULL, z REAL NOT NULL, yaw REAL NOT NULL DEFAULT 0, pitch REAL NOT NULL DEFAULT 0, created_at INTEGER NOT NULL DEFAULT 0, PRIMARY KEY(uuid, name))");
